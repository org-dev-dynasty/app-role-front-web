  ...
  const showError = (message: any) => {
    if (toast.current) {
      toast.current.show({
        ...
        life: 3000,
        className:
          'bg-transparent text-red-500 border-2 border-white border-opacity-60 p-2 rounded-xl',
      });
    }
  };
  ...
  return (
    <>
      <Toast
        ref={toast}
        position='top-center'
        className='toast-center mt-10 bg-[#1D1D1D] bg-opacity-40 rounded-xl'
        pt={{
          summary: {
                ...
                <div className='flex'>
                  <div className='flex flex-col'>
                    ...
                    <div className='mt-[23px]'>
                      ...
                      />
                      {emailError && (
                        <p className='text-red-500 ml-[68px]'>{emailError}</p>
                      )}
                    </div>
                  </div>
