    ...
    <div className="bg-[#2A2A2A] h-[100vh] w-full flex justify-center items-center">
      <div className="h-2/3 w-[40%] bg-[#363636] rounded-xl py-10 shadow-lg flex items-center flex-col">
        ...
        <div className="flex w-full h-full flex-col justify-center items-center ">
          ...
          {isVisible ?
            <div className="bg-[#6A6A6A] mt-4 rounded-lg h-10 w-4/5 shadow-lg flex justify-between items-center pr-5">
              <input type="text" className="rounded-lg outline-none p-5 h-full w-full bg-transparent text-white" value={password} onChange={(event) => handlePassword(event)} placeholder="Senha" />
              <EyeSlash size={30} className="hover:cursor-pointer  text-white" onClick={() => setIsVisible(!isVisible)} />
            </div> :
            <div className="bg-[#6A6A6A] mt-4 rounded-lg h-10 w-4/5 shadow-lg flex justify-between pr-5 items-center">
